...
export const metadata: Metadata = {
  ...
  description: 'Browse movies and TV shows on Netflix Clone.',
};

/**
 * Browse Component (Server Component)
 * 
 * This is the main browse page of the Netflix clone.
 ...
 */
export default async function Browse(): Promise<ReactElement> {
  ...
  const originalVideos = await prisma.video.findMany({
          ...
          <nav className="main-nav">
            <ul className="nav-links">
              <li className="nav-item">
                <Link href="/browse" className="nav-link active">
                  Home
                </Link>
              </li>
              <li className="nav-item">
      ...
      <main className="browse-main">
        ...
        {originalVideos.length > 0 && (
          <section className="content-section">
            ...
            <div className="content-row originals-row">
              {originalVideos.map((item) => (
                <div key={item.id} className="content-card original-card">
                  <img 
                    src={item.thumbnailUrl} 
                    alt={item.title} 
                    className="content-image"
